...
vignette: >
  %\VignetteIndexEntry{From trio information to full families}
...
*Note: This vignette was originally published with the LTFHPlus package [here](https://emilmip.github.io/LTFHPlus/articles/FromTrioToFamilies.html)*
...
Finally, the kinship matrix can be calculated with `get_covmat()` in the following way:
```{r}
